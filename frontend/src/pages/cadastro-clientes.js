 ...
 app.innerHTML = `
    <div class="page-container">
      <header class="page-header">
        <a href="#" id="back-link" class="back-button" title="Voltar" aria-label="Voltar"><i class="fas fa-arrow-left"></i></a>
  ...
  // === Form submit para enviar dados para backend ===
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      await createClient(data); // envia para o backend
      alert('Cliente cadastrado com sucesso!');
      form.reset();

      // Navega direto para a lista de clientes
